                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('racks.destroy',$rack->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('racks.show',$rack->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('racks.edit',$rack->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                    @csrf
                                                    @method('DELETE')
