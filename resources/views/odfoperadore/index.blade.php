                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('odfoperadores.destroy', $odfoperadore->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary" href="{{ route('odfoperadores.show', $odfoperadore->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('odfoperadores.edit', $odfoperadore->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                    @csrf
                                                    @method('DELETE')
